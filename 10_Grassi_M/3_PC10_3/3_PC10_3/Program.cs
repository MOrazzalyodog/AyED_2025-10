...
namespace _3_PC10_3
{
    class Program
    {
        ...
        static int CrearNuevoEncargo(int cantidadEncargos)
        {
            Console.Clear();
        ...
        static int MostrarTodosLosEncargos()
        {
            Console.Clear();
        ...
        static int AsignarCamionAEncargo()
        {
            Console.Clear();
        ...
        static int MostrarEncargosAsignados()
        {
            Console.Clear();
        ...
        static int CalcularPromedioGananciaPorSede()
        {
            Console.Clear();
        ...
        static int MostrarEncargoMayorDistancia()
        {
            Console.Clear();
            ...
            if (cantidadEncargos > 0 && int.TryParse(encargos[0, 1], out firstDistance))
            {
                maxDistancia = firstDistance;
            }
            ...
            for (int i = 0; i < cantidadEncargos; i++)
            {
                if (int.TryParse(encargos[i, 1], out currentDistance) && currentDistance == maxDistancia)
                {
                    Console.WriteLine($"{i + 1}\t{encargos[i, 0]}\t\t{encargos[i, 1]}\t\t{encargos[i, 2]}\t{encargos[i, 3]}\t\t{encargos[i, 4]}");
                    cantidadMaximos++;
                }
